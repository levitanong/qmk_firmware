...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_LAYER0] = LAYOUT_65_ansi( /* Base */
			...
			CTL_T(KC_CAPS),KC_A,     KC_S,     KC_D,  KC_F,  KC_G,  KC_H,    KC_J,  KC_K,    KC_L,     KC_SCLN,  KC_QUOT,           KC_ENT,    KC_AUDIO_VOL_UP,\
		    KC_LSFT,       KC_Z,     KC_X,     KC_C,  KC_V,  KC_B,  KC_N,    KC_M,  KC_COMM, KC_DOT,   KC_SLSH,  KC_LEAD,           KC_UP,     KC_AUDIO_VOL_DOWN,\
		    KC_LCTL,       KC_LALT,  KC_LGUI,                KC_SPC,                KC_RGUI, MO(1),    MO(2),    KC_LEFT,           KC_DOWN,   KC_RIGHT),
